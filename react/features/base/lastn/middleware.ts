...
import { VIRTUAL_SCREENSHARE_REMOTE_PARTICIPANTS_UPDATED } from '../../video-layout/actionTypes';
...
const _updateLastN = debounce(({ dispatch, getState }: IStore) => {
    ...
    // Mobile-specific carMode and appState checks removed (car mode is mobile-only feature)
    if (audioOnly) {
